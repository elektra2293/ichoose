...
if (empty($avatar))
{echo "<img src='images/nophoto.jpg' width='200' height='auto' alt='name' /><div>
...
<?php
		...
		echo'<div><label style="font-size:30px; float:left; font-weight:bold; color:#006">'.$companies['Company_Name'].'</label><div class="rating" style=" margin_top:20px;">
                <input type="hidden" name="val" value="'.$total_raiting.'"/>
                <input type="hidden" name="votes" value="'.$total_raiting.'"/></div></div>';
